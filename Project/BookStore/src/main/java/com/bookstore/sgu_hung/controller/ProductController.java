...
import com.bookstore.sgu_hung.dao.CategoryDAO;
import com.bookstore.sgu_hung.dao.ProductDAO;
import com.bookstore.sgu_hung.entity.Category;
import com.bookstore.sgu_hung.entity.Product;
import com.bookstore.sgu_hung.service.HttpService;
import com.bookstore.sgu_hung.service.MailerService;
...
public class ProductController {
	...
	public String getAll(Model model){
		List<Product> entity = pdao.findAll();
		return http.layout("product");
	}
